...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Persist FlashInfer autotune results to `SGLANG_CACHE_DIR` and reuse them across runs. Set to `0` to disable the cache (re-autotunes on every startup).</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>`true`</td>
    </tr>
    <tr>
